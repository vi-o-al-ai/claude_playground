...
const Game = (() => {
    ...
    function handleWin() {
        ...
        showModal(
            ...
            [
                { text: 'New Game', class: 'modal-btn-primary', action: () => { hideModal(); newGame(); } },
                { text: 'Share', class: 'modal-btn-secondary', action: () => { hideModal(); shareGame(); } }
            ]
        );
    }
    ...
    function handleGameOver() {
        ...
        showModal(
            ...
            [
                { text: 'Try Again', class: 'modal-btn-primary', action: () => { hideModal(); newGame(); } },
    ...
    function loadGame() {
        ...
        if (!raw) {
            showModal(
                'No Saved Game',
                'There is no saved game to resume.',
                [{ text: 'OK', class: 'modal-btn-primary', action: hideModal }]
            );
            return;
        }
        ...
        try {
            ...
            showModal(
                'Game Resumed',
                `Your ${difficulty} game has been loaded.`,
                [{ text: 'OK', class: 'modal-btn-primary', action: hideModal }]
            );
        } catch {
            showModal(
                'Error',
                'Could not load saved game. The save data may be corrupted.',
                [{ text: 'OK', class: 'modal-btn-primary', action: hideModal }]
            );
        }
    }
